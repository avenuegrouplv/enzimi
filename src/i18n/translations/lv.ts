...
export const lvTranslations: Translations = {
  ...
  hero: {
    ...
    subtitle: "Mājražotāja gatavoti fermentēti dabiski dzērieni, kas tiek iegūti, raudzējot augļus, dārzeņus un citas dabīgas izejvielas, kas atbalsta gremošanas sistēmu un stiprina imunitāti. Bez pievienota cukura. Katrs dzēriens tiek radīts ar rūpību, saglabājot dabas pirmatnējo spēku un atjaunojošo enerģiju.",
